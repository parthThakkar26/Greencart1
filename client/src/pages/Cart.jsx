...
//         const addrArray = Array.isArray(data.address)
//           ? data.address
//           : data.address
//           ? [data.address]
//           : [];

//         setAddress(addrArray);

//         if (addrArray.length > 0) {
//           setSelectedAddress(addrArray[0]);
//         }
//       } else {
//         toast.error(data.message);
//       }
...
//   const placeOrder = async () => {
//     toast.success("Place order logic goes here!");
//   };
